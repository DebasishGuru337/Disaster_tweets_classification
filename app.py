...
model = joblib.load('/Users/debasishguru/Desktop/untitled folder/Next Project Hike 7/models/Logistic Regression.joblib')

# Load the TF-IDF vectorizer
vectorizer = joblib.load('/Users/debasishguru/Desktop/untitled folder/Next Project Hike 7/models/tfidf_vectorizer.joblib')  # Load the vectorizer used for training
...
def predict():
    ...
    return render_template("result.html", result=result,text=tweet_text)
